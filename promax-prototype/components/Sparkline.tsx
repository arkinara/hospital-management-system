 ...
 */
export const Sparkline: React.FC<SparklineProps> = ({ values, tone = 'primary', width = 132, height = 34 }) => {
  ...
  return (
    <svg viewBox={`0 0 ${width} ${height}`} className="w-full" style={{ height }} preserveAspectRatio="none" aria-hidden focusable="false">
      <defs>
